	...
	if ( have_posts() ) :
		...
		while ( have_posts() ) :
			...
			the_post();
			  ...
			  // <?php if (is_single('58')):?
			  // <a href="http://gest-house.local/cost/"></a>
				// <?php endif; ?
			
			  // <?php if (is_single('56')):?
			  // <a href="http://gest-house.local/ryoukin/"></a>
				// <?php endif; ?
			...
			<article id="post-<?php the_ID(); ?>" <?php post_class($post_class); ?>>
				...
				<?php if(in_category('event')):?>
						<a href="http://gest-house.local/%e3%82%a4%e3%83%99%e3%83%b3%e3%83%88-2/"><?php esc_html_e( 'read more','ashe' ); ?></a>
					<?php endif;?>
					
					<?php if(in_category('guesthouse')):?>
						<a href="http://gest-house.local/cost/"><?php esc_html_e( 'read more','ashe' ); ?></a>
					<?php endif;?>
					
					
					<?php if(in_category('space')):?>
						<a href="http://gest-house.local/ryoukin/"><?php esc_html_e( 'read more','ashe' ); ?></a>
					<?php endif;?>
					
					<?php if(in_category('consept')):?>
						<a href="http://gest-house.local/about-us/"><?php esc_html_e( 'read more','ashe' ); ?></a>
					<?php endif;?>
